...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TENANTUSER_LIST actions', async () => {
    ...
    it('dispatches FETCH_TENANTUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TENANTUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TENANTUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TENANTUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TENANTUSER actions', async () => {
      const expectedActions = [
        {
