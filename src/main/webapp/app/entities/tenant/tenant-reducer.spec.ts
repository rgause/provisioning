...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './tenant.reducer';
...
describe('Entities reducer tests', () => {
  ...
  const initialState: EntityState<ITenant> = {
    loading: false,
    errorMessage: null,
    entities: [],
    entity: defaultValue,
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TENANT_LIST actions', async () => {
    ...
    it('dispatches FETCH_TENANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TENANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TENANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TENANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TENANT actions', async () => {
      const expectedActions = [
        {
