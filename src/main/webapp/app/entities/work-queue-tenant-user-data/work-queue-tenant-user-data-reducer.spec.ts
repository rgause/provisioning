...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './work-queue-tenant-user-data.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORKQUEUETENANTUSERDATA_LIST actions', async () => {
    ...
    it('dispatches FETCH_WORKQUEUETENANTUSERDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WORKQUEUETENANTUSERDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WORKQUEUETENANTUSERDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WORKQUEUETENANTUSERDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WORKQUEUETENANTUSERDATA actions', async () => {
      const expectedActions = [
        {
