...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TENANTPROPERTY_LIST actions', async () => {
    ...
    it('dispatches FETCH_TENANTPROPERTY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TENANTPROPERTY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TENANTPROPERTY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TENANTPROPERTY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TENANTPROPERTY actions', async () => {
      const expectedActions = [
        {
