...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORKTEMPLATE_LIST actions', async () => {
    ...
    it('dispatches FETCH_WORKTEMPLATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WORKTEMPLATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WORKTEMPLATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WORKTEMPLATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WORKTEMPLATE actions', async () => {
      const expectedActions = [
        {
