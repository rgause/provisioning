...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './tenant-property-key.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TENANTPROPERTYKEY_LIST actions', async () => {
    ...
    it('dispatches FETCH_TENANTPROPERTYKEY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TENANTPROPERTYKEY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TENANTPROPERTYKEY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TENANTPROPERTYKEY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TENANTPROPERTYKEY actions', async () => {
      const expectedActions = [
        {
