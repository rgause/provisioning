...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './url-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_URLTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_URLTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_URLTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_URLTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_URLTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_URLTYPE actions', async () => {
      const expectedActions = [
        {
