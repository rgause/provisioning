...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './work-queue-tenant-user.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORKQUEUETENANTUSER_LIST actions', async () => {
    ...
    it('dispatches FETCH_WORKQUEUETENANTUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WORKQUEUETENANTUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WORKQUEUETENANTUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WORKQUEUETENANTUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WORKQUEUETENANTUSER actions', async () => {
      const expectedActions = [
        {
