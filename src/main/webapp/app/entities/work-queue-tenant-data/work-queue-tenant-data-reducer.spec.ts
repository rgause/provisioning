...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './work-queue-tenant-data.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORKQUEUETENANTDATA_LIST actions', async () => {
    ...
    it('dispatches FETCH_WORKQUEUETENANTDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WORKQUEUETENANTDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WORKQUEUETENANTDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WORKQUEUETENANTDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WORKQUEUETENANTDATA actions', async () => {
      const expectedActions = [
        {
