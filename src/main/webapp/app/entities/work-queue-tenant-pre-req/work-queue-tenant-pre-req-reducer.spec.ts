...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './work-queue-tenant-pre-req.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORKQUEUETENANTPREREQ_LIST actions', async () => {
    ...
    it('dispatches FETCH_WORKQUEUETENANTPREREQ actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WORKQUEUETENANTPREREQ actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WORKQUEUETENANTPREREQ actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WORKQUEUETENANTPREREQ actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WORKQUEUETENANTPREREQ actions', async () => {
      const expectedActions = [
        {
