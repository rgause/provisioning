...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './url.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_URL_LIST actions', async () => {
    ...
    it('dispatches FETCH_URL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_URL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_URL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_URL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_URL actions', async () => {
      const expectedActions = [
        {
