...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TENANTTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_TENANTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TENANTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TENANTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TENANTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TENANTTYPE actions', async () => {
      const expectedActions = [
        {
