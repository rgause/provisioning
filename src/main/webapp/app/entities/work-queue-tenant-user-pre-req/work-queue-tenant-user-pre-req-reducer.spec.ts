...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './work-queue-tenant-user-pre-req.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORKQUEUETENANTUSERPREREQ_LIST actions', async () => {
    ...
    it('dispatches FETCH_WORKQUEUETENANTUSERPREREQ actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WORKQUEUETENANTUSERPREREQ actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WORKQUEUETENANTUSERPREREQ actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WORKQUEUETENANTUSERPREREQ actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WORKQUEUETENANTUSERPREREQ actions', async () => {
      const expectedActions = [
        {
