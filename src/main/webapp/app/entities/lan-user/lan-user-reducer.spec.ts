...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './lan-user.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LANUSER_LIST actions', async () => {
    ...
    it('dispatches FETCH_LANUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LANUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LANUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LANUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LANUSER actions', async () => {
      const expectedActions = [
        {
