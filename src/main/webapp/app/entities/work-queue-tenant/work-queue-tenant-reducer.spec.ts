...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './work-queue-tenant.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORKQUEUETENANT_LIST actions', async () => {
    ...
    it('dispatches FETCH_WORKQUEUETENANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WORKQUEUETENANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WORKQUEUETENANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WORKQUEUETENANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WORKQUEUETENANT actions', async () => {
      const expectedActions = [
        {
