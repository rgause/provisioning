...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './work-template-item-pre-req.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORKTEMPLATEITEMPREREQ_LIST actions', async () => {
    ...
    it('dispatches FETCH_WORKTEMPLATEITEMPREREQ actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WORKTEMPLATEITEMPREREQ actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WORKTEMPLATEITEMPREREQ actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WORKTEMPLATEITEMPREREQ actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WORKTEMPLATEITEMPREREQ actions', async () => {
      const expectedActions = [
        {
