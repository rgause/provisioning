...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './work-template-item.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORKTEMPLATEITEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_WORKTEMPLATEITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WORKTEMPLATEITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WORKTEMPLATEITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WORKTEMPLATEITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WORKTEMPLATEITEM actions', async () => {
      const expectedActions = [
        {
